...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-dr6(w&0-s8($%f&1$i8md4ns#f0j8ioe2op+-4n3v5g02v3zxz')
...
# Add CSRF trusted origins for secure cross-origin requests
...
# Only if dj_database_url is installed
try:
